"""Configuracion de las pruebas del servicio de fincas.

Las pruebas corren contra SQLite en memoria para no depender de PostgreSQL
dentro del pipeline de integracion continua.
"""
